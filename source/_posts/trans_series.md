...
![这个图片](source/_posts/paper_image/trans_series/image3.png "TransE和TransH对比")  
...
对于一个关系r, 我们首先要统计两个数值，即这个关系每个头结点平均对应的尾节点数，记做 tph；及这个关系每一个尾节点平均对应的头节点数，记做 hpt 。最后通过公式p=\frac{tph}{tph+hpt}来表示头结点没被替换的概率，而尾节点替换的概率为1-p。  
