...
![图片](../images/2024/05/16/prompt_competion/image.png "数据图")

之后，GPT-4 以我们要求的 markdown 报告格式回复其分析结果：
![图片](../images/2024/05/16/prompt_competion/image1.png "数据图")
...
* 深入研究这些数据集，这些行的完整数据为：
![图片](../images/2024/05/16/prompt_competion/image3.png "数据图")
...
![图片](../images/2024/05/16/prompt_competion/image4.png "数据图")
...
![图片](../images/2024/05/16/prompt_competion/image6.png "数据图")
...
![图片](../images/2024/05/16/prompt_competion/image7.png "数据图")
